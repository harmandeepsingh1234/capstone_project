...
{  
	if(line==1)  position = 0x80+position;  //Predefined position for line 1
	...
	ln1 = 0b11111100;  //Command for lcd to know that incoming data is Command
	ln2 = 0b11111000;  //Command for lcd to know that incoming data is opmmand
