 ...
 int main (void) // Main function
{
    ...
    printf("\nEnter Number of High Temp Persons : ");
	scanf("%d", &hightemp);
	sprintf(buffer1, "%d", hightemp);
	strcat(buf, buffer1); // Copy a string in buf char array
    ...
    printf("Sent Data to Thingspeak via UART : %s  -Bytes: %d\n", buf ,bytes_written);
